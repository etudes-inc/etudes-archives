/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/archives/trunk/archives-plugin/plugin/src/java/org/etudes/archives/plugin/PurgeUserTrackingHandler.java $
 * $Id: PurgeUserTrackingHandler.java 2988 2012-06-14 03:13:02Z ggolden $
 ***********************************************************************************
 *
...
/**
 * Archives PurgeUserHandler for the inTouch tracking data
 */
public class PurgeUserTrackingHandler implements PurgeUserHandler
{
	/** Our log. */
	private static Log M_log = LogFactory.getLog(PurgeUserTrackingHandler.class);

	/** The application Id. */
	protected final static String applicationId = "cdp.tracking";
	...
	public void purge(String userId)
	{
		...
		fields[0] = userId;
		delete("DELETE FROM TRACKER_USER_TRACKING WHERE USER_ID = ?", fields);
	}
