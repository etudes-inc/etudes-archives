/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/archives/trunk/archives-plugin/plugin/src/java/org/etudes/archives/plugin/PurgeUserArchivesHandler.java $
 * $Id: PurgeUserArchivesHandler.java 2988 2012-06-14 03:13:02Z ggolden $
 ***********************************************************************************
 *
...
/**
 * Archives PurgeUserHandler for the archives (ownership) data
 */
public class PurgeUserArchivesHandler implements PurgeUserHandler
{
	/** Our log. */
	private static Log M_log = LogFactory.getLog(PurgeUserArchivesHandler.class);
	...
	public void purge(String userId)
	{
		...
		fields[0] = userId;
		delete("DELETE FROM ARCHIVES_OWNERS WHERE USER_ID = ?", fields);
	}
