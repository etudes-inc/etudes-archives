/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/archives/trunk/archives-plugin/plugin/src/java/org/etudes/archives/plugin/PurgeUserMeleteHandler.java $
 * $Id: PurgeUserMeleteHandler.java 3011 2012-06-20 05:05:48Z ggolden $
 ***********************************************************************************
 *
...
/**
 * Archives PurgeUserHandler for Melete user data
 */
public class PurgeUserMeleteHandler implements PurgeUserHandler
{
	/** Our log. */
	private static Log M_log = LogFactory.getLog(PurgeUserMeleteHandler.class);
	...
	public void purge(String userId)
	{
		...
		fields[0] = userId;
		delete("DELETE FROM MELETE_USER_PREFERENCE WHERE USER_ID = ?", fields);
	}
