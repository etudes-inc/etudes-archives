/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/archives/trunk/archives-plugin/plugin/src/java/org/etudes/archives/plugin/PurgeCalendarHandler.java $
 * $Id: PurgeCalendarHandler.java 2903 2012-05-03 23:46:24Z ggolden $
 ***********************************************************************************
 *
...
/**
 * Archives PurgeHandler for Calendar
 */
public class PurgeCalendarHandler implements PurgeHandler
{
	/** Our log. */
	private static Log M_log = LogFactory.getLog(PurgeCalendarHandler.class);
	...
	public void purge(String siteId)
	{
		...
		String calendar = "/calendar/calendar/" + siteId + "/main";

		// get any attachment CHS references that are not in the site's attachments area
		List<String> attachments = readAttachmentInfo(siteId, calendar);

		// channel id for the prepared statements
		Object[] fields = new Object[1];
		fields[0] = calendar;

		delete("DELETE FROM CALENDAR_EVENT WHERE CALENDAR_ID = ?", fields);
		delete("DELETE FROM CALENDAR_CALENDAR WHERE CALENDAR_ID = ?", fields);
	 ...
	 */
	protected List<String> readAttachmentInfo(final String siteId, String calendar)
	{
		String sql = "SELECT XML FROM CALENDAR_EVENT WHERE CALENDAR_ID = ?";
		Object[] fields = new Object[1];
		fields[0] = calendar;
